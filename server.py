...
def view_job_card(job_id):
    ...
    return render_template('erp_job_detail.html', job_id=job_id, job=job, 
                           ...
                           total_estimation=(parts_cost + labor_cost),
    ...
    try:
        execute_double_entry(
            ...
            movements=[
                ...
                (40000, 0.00, grand_total),
                (50000, cogs_valuation, 0.00),
                (12000, 0.00, cogs_valuation),
                (51000, labor_cost, 0.00),
                (10100, 0.00, labor_cost)
            ]
        )
